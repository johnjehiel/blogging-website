...
import { removeFromLocalStorage } from '../common/session';
  ...
  return (
    <AnimationWrapper className="absolute right-0 z-50" transition={{ duration: 0.2 }}>
        ...
        <div className='bg-white absolute right-0 border border-grey w-60 duration-200'>
            ...
            <Link to={`/user/${username}`} className='link pl-8 p-4'>
                Profile
            </Link>

            <Link to={"/dashboard/blogs"} className='link pl-8 p-4'>
                Dashboard
            </Link>

            <Link to={"/settings/edit-profile"} className='link pl-8 p-4'>
                Settings
            </Link>
