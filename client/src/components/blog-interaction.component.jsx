...
const BlogInteraction = () => {
    ...
    useEffect(() => {
        ...
        if (access_token) {
            // make request to server to get the like info
    ...
    const handleLike = () => {
        ...
        if (access_token) {
            ...
            !isLikedByUser ? total_likes++ : total_likes--; // toggle like button
            setBlog({ ...blog, activity: { ...activity, total_likes } }) // save the updated value in the original blog
