...
const BlogPage = () => {
    ...
    useEffect(() => {
        resetStates();
        fetchBlog();
    }, [blog_id]) // blog_id will change when we click on a similar blog to be redirected to that clicked similar blog 
                        ...
                        <div className="mt-12">
                            ...
                            <div className="flex max-sm:flex-col justify-between my-8">
                                <div className="flex gap-5 items-start">
                                    <img src={profile_img} className="w-12 h-12 rounded-full" alt="profile image" />
                                    <p>
                                        {fullname}
                                        <br />
                                        @
                        ...
                        <div className="my-12 font-gelasio blog-page-content">
                            {
                                content[0].blocks.map((block, index) => {
                                    return <div className="my-4 md:my-8" key={index}>
                                ...
                                <>
...

                                    {
                                        similarBlogs.map((blog, index) => {
                                            ...
                                            return <AnimationWrapper transition={{ duration: 1, delay: index*0.08 }} key={index}>
